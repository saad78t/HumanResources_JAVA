...
//		 if (EmployeeNumber!=0) return EmployeeNumber;
	 ...
	 public void tulosta(PrintStream out) {
	     ...
	     *   contract.toString().startsWith("1|1199|20|1.7.2019|1.6.2020|8|10|One|") === true; // on enemmäkin kuin 3 kenttää, siksi loppu |
	     * </pre>  
	     */
	    @Override
...
//	                ContractPeriod + "|" ;	                 	              
	   ...
	   /**
	     ...
	     *   contract.rekisteroi();           // ja tarkistetaan että seuraavalla kertaa tulee yhtä isompi

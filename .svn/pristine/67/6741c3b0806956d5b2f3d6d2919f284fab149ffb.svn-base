 ...
 *
 */
public class TietueDialogeController<TYPE extends Tietue> implements ModalControllerInterface<TYPE>,Initializable  {
...
// ========================================================   
    ...
    public static<TYPE extends Tietue> TYPE kysyTietue(Stage modalityStage, TYPE oletus, int kentta) {
        return ModalController.<TYPE, TietueDialogeController<TYPE>>showModal(
                TietueDialogeController.class.getResource("TietueDialogeView.fxml"),
                "HumanResources",

...
//		 if (EmployeeNumber!=0) return EmployeeNumber;
 ...
 public void setEmployeeNumber(int nr){
     ...
     *   salary.toString().startsWith("1|32132131|1000.0|5|2018|20.0|2121.0|2222.0|1121.0|") === true; // on enemmäkin kuin 3 kenttää, siksi loppu |
     * </pre>  
     */
 @Override
...
//	            NetSalary + "|" ;	               	            	                           
  ...
  *   salary.toString().startsWith("1|1199|20|1.7.2019|1.6.2020|8|10|One|") === true; // on enemmäkin kuin 3 kenttää, siksi loppu |
  *   salary.rekisteroi();
  *   int n = salary.getEmployeeNumber();
  *   salary.parse(""+(n+20));       // Otetaan merkkijonosta vain tunnusnumero
  *   salary.rekisteroi();           // ja tarkistetaan että seuraavalla kertaa tulee yhtä isompi
